...
showError("this is CubeCustom");
    ...
    out vec4 varyColor;
    void main() {
        gl_Position = u_perspective  * vec4(vertexPosition, 1.0);
   ...
   function scaleMatrix(matrix, scaleVector) {
    ...
    // PERSPECTIVE MATRIX
        ...
        // Adoonis perspective matrix
        var perspectiveMatrix = perspective([], 75 * Math.PI/180, canvas.width/canvas.height, 0.1, 10000);

        gl.uniformMatrix4fv(uniformLocations.uPerspective, false, perspectiveMatrix); //
